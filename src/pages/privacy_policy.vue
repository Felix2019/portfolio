<template>
  <div class="p-6 space-y-4 bg-background">
    ...
    <p>
      Felix, Günthner<br />Kyffhäuserstraße, 57<br />50674, Köln, Deutschland
    </p>
    E-Mail-Adresse:
    <p>
    ...
    Impressum:
    <p>
      <a href="https://felixguenthner.com/imprint" target="_blank"
        >https://felixguenthner.com/imprint</a
      >
    </p>
    ...
    <ul class="m-elements">
      <li>
        ...
        <strong>Dienstanbieter:</strong> A Medium Corporation, P.O. Box 602, San
        Francisco, CA 94104–0602, USA; <strong>Website:</strong>
